...
require 'open-uri'
Omamori.destroy_all
omamori1 = Omamori.new(name: "IT", jinja:"神田明神",tags:["IT"],color:"緑")
...
omamori2 = Omamori.new(name: "縁結び", jinja:"今戶神社",tags:["縁結び"],color:"黄色")
...
omamori3 = Omamori.new(name: "縁結び", jinja:"陽運寺",tags:["縁結び"],color:"ピンク")
